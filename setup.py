...
setup(
    ...
    install_requires=["colorama==0.4.6; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3, 3.4, 3.5, 3.6'", 'vistir==0.6.1'],  # Optional
